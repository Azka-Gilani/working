...
def makeWebhookResult(data):
    ...
    speech = "This is the response from server... " +city1+ row1_title + row1_subtitle + row1_img_url + row1_web_url+row2_title + row2_subtitle + row2_img_url + row2_web_url
    print("Response:")
    print(speech)
    message= {
      "attachment": {
